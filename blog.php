                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">Most Popular Education Posts Of The
                                    Week 20-26 Aug</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">Global education: Ideas for the way
                                    move forward</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">What’s Going On in This Picture? |
                                    Jan. 13, 2021</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">Connecting Math and Science to Reading
                                    and Writing</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">How to Introduce Meditation to the
                                    High School</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post mb-30">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog.html" class="d-inline-block">Tools for Creating Digital Student
                                    Portfolios</a></h3>
                            <a href="#" class="read-more-btn">Read More <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
