...
<head>
    ...
    <title>Aviation, Hospitality and Tourism Management
        | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Aviation, Hospitality and Tourism Management
                    </li>
                </ul>
                <h2>Aviation, Hospitality and Tourism Management
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p><strong>Career prospects</strong> This course will enable the students to write their own success stories for careers in the aviation, tourism & hospitality industry. </p>
                    <p> On successful completion of this course, students can work for airports or airlines, hotels, or travel companies.
                    </p>
