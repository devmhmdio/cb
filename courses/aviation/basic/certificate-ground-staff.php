...
<head>
    ...
    <title>Certificate in Ground Staff
        | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Certificate in Ground Staff
                    </li>
                </ul>
                <h2>Certificate in Ground Staff
                </h2>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        <ul>
                            ...
                            <li>
                                <span><i class='bx bx-tachometer'></i> Learning Effort:</span> 4 Hrs/Day, 6 Days/Week
                            </li>
                    ...
                    <p><strong>Career prospects</strong> This professional course in ground staff services will prepare you to handle ground activities at domestic and international airports. </p>
