...
<head>
    ...
    <title>Advance Course in Beauty Therapy
        | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Advance Course in Beauty Therapy
                    </li>
                </ul>
                <h2>Advance Course in Beauty Therapy
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p>Being an advanced course, it gives a deeper understanding of advanced skin treatments and helps students become expert professionals.</p>
