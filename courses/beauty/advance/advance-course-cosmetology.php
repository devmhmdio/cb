...
<head>
    ...
    <title>Advance Course in Cosmetology | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Advance Course in Cosmetology</li>
                </ul>
                <h2>Advance Course in Cosmetology</h2>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        <ul>
                            ...
                            <li>
                                <span><i class='bx bx-time'></i> Duration:</span> 12 Months
                            </li>
                            <li>
                        ...
                        <p>The advanced course in Cosmetology focuses on preparing the candidate to receive an inherent understanding of end-to-end beauty regimes. </p>
