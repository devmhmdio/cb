...
<head>
    ...
    <title>Advanced course in Hair Technology | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Advanced course in Hair Technology</li>
                </ul>
                <h2>Advanced course in Hair Technology</h2>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="courses-details-image text-center">
                        <img src="../../../assets/img/courses/g2.jpg" alt="image">
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        <ul>
                            ...
                            <li>
                                <span><i class='bx bxs-badge-check'></i> Level:</span> Advance
                            </li>
                            <li>
                        ...
                        <p>Our course is designed to convert students into veteran hair professionals who are highly in demand at hair salons, beauty parlours, etc. Advance topics will give in-depth knowledge on the Anatomy of hair and scalp, Haircuts, Hair colouring, Professional deep conditioning, etc.</p>
