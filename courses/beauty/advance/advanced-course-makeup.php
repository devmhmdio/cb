...
<head>
    ...
    <title>Advanced Course in Makeup | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Advanced Course in Makeup</li>
                </ul>
                <h2>Advanced Course in Makeup</h2>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        <ul>
                            ...
                            <li>
                                <span><i class='bx bx-time'></i> Duration:</span> 4 Months
                            </li>
                            <li>
                    ...
                    <p>Our Advanced course offers specialized in-depth know-how of makeup as a skill & the required details of all aspects of makeup to become a seasoned professional with unlimited scope & specialization covering all aspects of makeup.
                    </p>
