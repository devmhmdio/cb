...
<head>
    ...
    <title>Foundation Course in Beauty Therapy | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Foundation Course in Beauty Therapy</li>
                </ul>
                <h2>Foundation Course in Beauty Therapy</h2>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        ...
                        <p>If you envision yourself in the glamorous and exciting world of beauty therapy, then endless possibilities as a Beauty Therapist await you.</p>
