        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Competitive Exams
                    </li>
                </ul>
                <h2>Competitive Exams
                </h2>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="courses-details-image text-center">
                        <img src="../../../assets/img/courses/spe1.png" alt="image" style="height: 595px;">
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="courses-sidebar-information">
                        <ul>
                            ...
                            <li>
                                <span><i class='bx bx-time'></i> Duration:</span> 2 Months
                            </li>
                            <li>
                    ...
                    <p><strong>Career prospects</strong> Competitive Exam is a unique course that would help you ace your exams by building a good foundation in English. It is designed to help you prepare for UPSC, IBPS/ Bank (PO & Clerical), SSC ( CGL and CHSL), and other government exams ( Insurance, CDS, etc,) </p>
