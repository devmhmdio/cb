...
<head>
    ...
    <title>Start Speaking + Speak Fluently
        | CourseBees</title>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li><a href="courses-2-columns-style-1.html">Combo</a></li>
                    <li>Start Speaking + Speak Fluently
                    </li>
                </ul>
                <h2>Start Speaking + Speak Fluently
                </h2>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="courses-details-image text-center">
                        <img src="../../../assets/img/courses/spe4.png" alt="image" style="height: 595px;">
                    </div>
