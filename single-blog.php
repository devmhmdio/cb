                ...
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc">
                        ...
                        <div class="article-content">
                            ...
                            <h3>Most Popular Education Posts Of The Week 20-26 Aug</h3>
                            <p>Quuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quia non
                                numquam eius modi tempora incidunt ut labore et dolore magnam dolor sit amet,
                            ...
                            <ul class="features-list">
                                <li><i class='bx bx-check-double'></i> Scientific Skills For getting a better result
                                </li>
                        ...
                        <section class="widget widget_raque_posts_thumb">
                            ...
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="single-blog.html">Making Peace With The Feast Or
                            ...
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="single-blog.html">I Used The Web For A Day On A 50
                                            MB Budget</a></h4>
                                </div>
                                <div class="clear"></div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="single-blog.html">How To Create A Responsive Popup
                                            Gallery?</a></h4>
                                </div>
                                <div class="clear"></div>
                            </article>
