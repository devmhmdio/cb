                        ...
                        <ul class="top-header-contact-info">
                            ...
                            <li>
                                ...
                                <a href="mailto:mrafique@moreyeahs.co"><span
                                        class="__cf_email__">hello@internshala.com</span></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item"><a href="#" class="nav-link">Home</a>
                                    <!-- <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a href="index-5.html" class="nav-link">Online Education Portal</a></li>
                                        <li class="nav-item"><a href="index-6.html" class="nav-link">Online Schooling</a></li>
                                        <li class="nav-item"><a href="index-7.html" class="nav-link">Learning School Online</a></li>
                                        <li class="nav-item"><a href="index-8.html" class="nav-link">Remote Training Online</a></li>
                                        <li class="nav-item"><a href="index-9.html" class="nav-link">Business Coaching</a></li>
                                        <li class="nav-item"><a href="index-10.html" class="nav-link">Health Coaching</a></li>
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav">
                                <li class="nav-item"><a href="#" class="nav-link">Home <i
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="index-2.html" class="nav-link">Distant
                                                Learning</a></li>
                                        <li class="nav-item"><a href="index-3.html" class="nav-link">Course Portal
                                                Online</a></li>
                                        <li class="nav-item"><a href="index-4.html" class="nav-link">Modern Teaching</a>
                                        </li>
                                        <li class="nav-item"><a href="index-5.html" class="nav-link">Online Education
                                                Portal</a></li>
                                        <li class="nav-item"><a href="index-6.html" class="nav-link">Online
                                                Schooling</a></li>
                                        <li class="nav-item"><a href="index-7.html" class="nav-link">Learning School
                                                Online</a></li>
                                        <li class="nav-item"><a href="index-8.html" class="nav-link">Remote Training
                                                Online</a></li>
                                        <li class="nav-item"><a href="index-9.html" class="nav-link">Business
                                                Coaching</a></li>
                                        <li class="nav-item"><a href="index-10.html" class="nav-link">Health
                                                Coaching</a></li>
                                        <li class="nav-item"><a href="index-11.html" class="nav-link">Language
                                                School</a></li>
                                        <li class="nav-item"><a href="index-12.html" class="nav-link">Gym Coaching</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item"><a href="#" class="nav-link">Pages <i
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="#" class="nav-link">About <i
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a href="about-style-1.html" class="nav-link">About
                                                        Style 1</a></li>
                                                <li class="nav-item"><a href="about-style-2.html" class="nav-link">About
                                                        Style 2</a></li>
                                                <li class="nav-item"><a href="about-style-3.html" class="nav-link">About
                                                        Style 3</a></li>
                                                <li class="nav-item"><a href="about-style-4.html" class="nav-link">About
                                                        Style 4</a></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item"><a href="#" class="nav-link">Instructor <i
                                                    class='bx bx-chevron-right'></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a href="team-1.html" class="nav-link">Instructor
                                                        Style 1</a></li>
                                                <li class="nav-item"><a href="team-2.html" class="nav-link">Instructor
                                                        Style 2</a></li>
                                                <li class="nav-item"><a href="team-3.html" class="nav-link">Instructor
                                                        Style 3</a></li>
                                        ...
                                        <li class="nav-item"><a href="#" class="nav-link">Events <i
                                                    class='bx bx-chevron-right'></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a href="events.html" class="nav-link">Events</a>
                                                </li>
                                        ...
                                        <li class="nav-item"><a href="error-404.html" class="nav-link">404 Error</a>
                                        </li>
                                        <li class="nav-item"><a href="coming-soon.html" class="nav-link">Comign Soon</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <!-- <li class="nav-item"><a href="#" class="nav-link">Shop <i
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a href="shop-grid-fullwidth.html" class="nav-link">Shop
                                                Grid FullWidth</a></li>
                                        <li class="nav-item"><a href="single-product.html" class="nav-link">Products
                                                Details</a></li>
